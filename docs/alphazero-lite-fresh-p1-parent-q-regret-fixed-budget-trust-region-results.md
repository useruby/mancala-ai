...
**Classification:** `root_q_constraint_stalls`

**Recommended follow-up:** Add a separate root action-value/Q head or increase representational degrees of freedom rather than weakening the constraint.
...
```json
{
  "cumulative_applied_full_update_norm_ratio": 0.05104472600346711,
  "fraction_lambda_0": 0.875,
  "fraction_lambda_0_125": 0.0625,
  "fraction_lambda_0_25": 0.0,
  "fraction_lambda_0_5": 0.0625,
  "fraction_lambda_1": 0.0,
  "longest_run_lambda_0": 14,
  "mean_lambda": 0.0390625,
  "median_lambda": 0.0
}
```
...
```json
{
  ...
  "constrained_metrics": {
    "1": {
      "adapter_norm": 0.00012057342974003404,
      "ce_search": 1.1008348048292487,
      "fit_fraction": 0.009097880456381454,
      "policy_l1_vs_p1": 6.001901666444031e-05
    },
    "16": {
      "adapter_norm": 0.00013724673772230744,
      "ce_search": 1.1008322352373074,
      "fit_fraction": 0.011819688377723724,
      "policy_l1_vs_p1": 7.249436848515203e-05
    },
    "4": {
      "adapter_norm": 0.00013724673772230744,
      "ce_search": 1.1008322352373074,
  ...
  "frozen": {
    "amplified": {
      ...
      "q_diagnostics": {
        "best_q_action_disagreement": 0.025,
        "centered_q_l1": 0.010897308985432041,
        "per_action_q_rank_disagreement": 0.03333333333333333,
        "q_direction_error": 0.03128948474368331,
        "root_move_disagreement": 0.05,
        "top_two_q_order_disagreement": 0.025,
        "visit_js": 0.0062673466478660265
      },
      "records": [
        {
          "candidate_move": 0,
    ...
    "washed": {
      ...
      "q_diagnostics": {
        ...
        "centered_q_l1": 0.0005513656114408473,
        "per_action_q_rank_disagreement": 0.0,
        "q_direction_error": 2.037336791359534e-05,
        "root_move_disagreement": 0.0,
        "top_two_q_order_disagreement": 0.0,
        "visit_js": 3.918561980404485e-07
      },
      "records": [
        {
          "candidate_move": 3,
  ...
  "generalization": {
    ...
    "primary": {
      "parent_q_regret_auc": 0.00042518480242603675
    },
    "secondary": {
      "parent_q_regret_auc": 4.3115407383111e-05
    },
    "washed": {
      "best_q_action_disagreement": 0.0,
      "centered_q_l1": 0.0005513656114408473,
