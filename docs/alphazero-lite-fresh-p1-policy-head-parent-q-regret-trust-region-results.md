...
**Classification:** `policy_head_constraint_still_stalls`

**Recommended follow-up:** Add a separate action-Q/search-consistency head rather than weakening the validated constraint.
...
```json
{
  ...
  "constraint_key": "parent_q_regret_auc",
  "empirical_p1_384_vs_1200_regret": 0.0,
  "epsilon_constraint": 0.001,
  "max": 0.0,
  "median": 0.0,
  "p90": 0.0
}
...
```json
{
  "cumulative_applied_full_update_norm_ratio": 0.0039518195426354935,
  "fraction_lambda_0": 0.9782608695652174,
  "fraction_lambda_0_125": 0.021739130434782608,
  "fraction_lambda_0_25": 0.0,
  "fraction_lambda_0_5": 0.0,
  "fraction_lambda_1": 0.0,
  "longest_run_lambda_0": 45,
  "mean_lambda": 0.002717391304347826,
  "median_lambda": 0.0
}
```
...
```json
{
  ...
  "baseline": {
    ...
    "metrics": {
      "1": {
        "ce_search": 1.1007447949032108,
        "fit_fraction": 0.10443976169396507,
        "policy_l1_vs_p1": 0.0006483269632530514,
        "trainable_parameter_delta_norm": 0.0009127488592639565
      },
      "16": {
        "ce_search": 1.0996006362055206,
        "fit_fraction": 1.3163754611652716,
        "policy_l1_vs_p1": 0.004700587834045175,
        "trainable_parameter_delta_norm": 0.007642010226845741
      },
      "4": {
        "ce_search": 1.100426588563786,
        "fit_fraction": 0.44149582159669515,
        "policy_l1_vs_p1": 0.002180225665932063,
        "trainable_parameter_delta_norm": 0.0025727723259478807
      },
      "46": {
        "ce_search": 1.0985609631429538,
        "fit_fraction": 2.4176360667500907,
        "policy_l1_vs_p1": 0.005565315116499709,
        "trainable_parameter_delta_norm": 0.017943263053894043
      }
    }
  },
  "constrained_metrics": {
    "1": {
      "ce_search": 1.1008310134745134,
      "fit_fraction": 0.013113825239488836,
      "policy_l1_vs_p1": 8.112118921728871e-05,
      "trainable_parameter_delta_norm": 0.0001141850370913744
    },
    "16": {
      "ce_search": 1.1008310134745134,
      "fit_fraction": 0.013113825239488836,
  ...
  "frozen": {
    "amplified": {
      ...
      "q_diagnostics": {
        ...
        "centered_q_l1": 0.0114526783596867,
        "per_action_q_rank_disagreement": 0.041666666666666664,
        "q_direction_error": 0.031366558434744285,
        "root_move_disagreement": 0.05,
        "top_two_q_order_disagreement": 0.05,
        "visit_js": 0.006270004147525117
      },
      "records": [
        {
          "candidate_move": 0,
    ...
    "washed": {
      ...
      "q_diagnostics": {
        ...
        "centered_q_l1": 0.0005828795878961551,
        "per_action_q_rank_disagreement": 0.0,
        "q_direction_error": 2.016888829097785e-05,
        "root_move_disagreement": 0.0,
        "top_two_q_order_disagreement": 0.0,
        "visit_js": 5.038975802620939e-07
      },
      "records": [
        {
          "candidate_move": 3,
  ...
  "generalization": {
    ...
    "primary": {
      "parent_q_regret_auc": 0.00041059719828867385
    },
    "secondary": {
      "parent_q_regret_auc": 5.716097755315512e-05
    },
    "washed": {
      "best_q_action_disagreement": 0.0,
      "centered_q_l1": 0.0005828795878961551,
