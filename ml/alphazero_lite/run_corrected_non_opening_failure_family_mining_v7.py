...
DEFAULT_OUT_ROOT = Path("/tmp/azlite_corrected_non_opening_failure_mining_v7")
DEFAULT_SUMMARY_PATH = DEFAULT_OUT_ROOT / "non_opening_failure_family_summary_v7.json"
DEFAULT_SELECTED_ROWS_PATH = (
    DEFAULT_OUT_ROOT / "selected_non_opening_family_rows_v7.jsonl"
)
DEFAULT_REPORT_PATH = Path(
    "docs/alphazero-lite-corrected-non-opening-failure-family-mining-v7-results.md"
)
...
def render_report(summary: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Projected family decision: `{STARVATION_PRESSURE_EXCLUSION_REASON}`.",
        "- Clean-enough rows: `0`.",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if selected_family_summary is not None:
        ...
        selected_family_report = {
            ...
            "reason_selected": (
                "highest-ranked remaining corrected non-opening family after excluding starvation_pressure after PR #62; "
    ...
    summary = {
        "schema": "azlite_corrected_non_opening_failure_family_mining_v6",
        "inventory_source": {
        ...
        "starvation_pressure_exclusion": {
            "excluded": True,
            "reason": STARVATION_PRESSURE_EXCLUSION_REASON,
            "projected_family_decision": STARVATION_PRESSURE_EXCLUSION_REASON,
            "clean_enough_row_count": 0,
            "reference_should_flip_row_count": 0,
            ...
            "starvation_pressure_remains_good_training_target": False,
            "source_doc_path": "docs/alphazero-lite-starvation-pressure-reference-adjudication-results.md",
        },
        "inventory_rows": [
            {
                "row_id": row["row_id"],
