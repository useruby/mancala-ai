...
DEFAULT_OUT_ROOT = Path("/tmp/azlite_corrected_non_opening_failure_mining_v5")
DEFAULT_SUMMARY_PATH = DEFAULT_OUT_ROOT / "non_opening_failure_family_summary_v5.json"
DEFAULT_SELECTED_ROWS_PATH = (
    DEFAULT_OUT_ROOT / "selected_non_opening_family_rows_v5.jsonl"
)
DEFAULT_REPORT_PATH = Path(
    "docs/alphazero-lite-corrected-non-opening-failure-family-mining-v5-results.md"
)
...
def render_report(summary: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Projected family decision: `{CAPTURE_AVAILABLE_EXCLUSION_REASON}`.",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if selected_family_summary is not None:
        ...
        selected_family_report = {
            ...
            "reason_selected": (
                "highest-ranked remaining corrected non-opening family after excluding capture_available after PR #59; "
    ...
    summary = {
        "schema": "azlite_corrected_non_opening_failure_family_mining_v5",
        "inventory_source": {
        ...
        "capture_available_exclusion": {
            "excluded": True,
            "reason": CAPTURE_AVAILABLE_EXCLUSION_REASON,
            "projected_family_decision": CAPTURE_AVAILABLE_EXCLUSION_REASON,
            "target_candidate_rows_eligible_after_active_references": 0,
            "target_candidate_rows_requiring_reference_patching": 3,
            "target_candidate_rows_that_should_stay_excluded": 7,
            "capture_available_remains_good_training_target": False,
            "source_doc_path": "docs/alphazero-lite-capture-available-reference-adjudication-results.md",
        },
        "inventory_rows": [
            {
                "row_id": row["row_id"],
