...
class SearchInteractionDiagnosticTest(unittest.TestCase):
    ...
    def test_resolve_target_rows_prefers_explicit_rows(self):
        ...
        self.assertEqual(
            ["capture_available-003", "incumbent_proxy_disagreement-031"], rows
        )
    ...
    def test_load_selected_artifact_path_prefers_selected_target(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                "/artifacts/real-selected", module.load_selected_artifact_path(run_dir)
            )

    def test_load_row_context_reads_current_original_rebalanced_and_optional_opening_rows(
        self,
    ):
        with tempfile.TemporaryDirectory() as tmp:
            tmp_path = Path(tmp)
        ...
        self.assertEqual(
            0,
            context["original_opening_row"]["candidate_searched_summary"][
                "selected_move"
            ],
        )
        self.assertEqual(
            2,
            context["rebalanced_opening_row"]["candidate_prior_summary"][
                "selected_move"
            ],
        )
    ...
    def test_build_artifact_row_normalizes_policy_visits_q_values_and_child_stats(self):
        ...
        self.assertEqual(
            {"0": 0.05, "1": 0.15, "2": 0.52, "3": 0.18, "4": 0.1},
            artifact_row["raw_policy_distribution"],
        )
        self.assertEqual({"0": 6, "2": 22, "3": 18}, artifact_row["per_move_visits"])
        self.assertEqual(
            {"0": 0.38, "2": 0.44, "3": 0.58}, artifact_row["per_move_q_values"]
        )
    ...
    def test_build_artifact_row_persists_missing_probe_fields_explicitly(self):
        ...
        self.assertEqual(
            {"0": 0.0, "2": 0.0, "4": 0.0}, artifact_row["raw_policy_distribution"]
        )
    ...
    def test_summarize_row_mechanism_prefers_selection_breakdown_and_distinguishes_snapshot_state(
        self,
    ):
        self.assertEqual(
    ...
    def test_decide_row_marks_search_overrides_prior_when_prior_is_correct_but_search_drifts(
        self,
    ):
        row_payload = {
            "reference_move": 2,
    ...
    def test_build_search_value_rows_marks_partial_probe_data_as_insufficient_child_stats(
        self,
    ):
        ...
        self.assertEqual(
            "insufficient_child_stats", rows["capture_available-002"]["decision"]
        )
        self.assertEqual(
    ...
    def test_build_search_value_interaction_payload_populates_rows_and_summary(self):
                    ...
                    side_effect=[
                        {
                            ...
                            "visit_snapshots": [
                                {"simulation": 64, "top_move": 2, "top_visits": 20}
                            ],
                        },
                        {
                            "selected_move": 2,
                        ...
                        },
                        {
                            "selected_move": 0,
                            "value": 0.61,
                            "policy": [0.08, 0.1, 0.51, 0.16, 0.15, 0.0],
                            "visits": [22, 4, 7, 9, 6, 0],
                            "child_stats": [
                                {"move": 0, "visits": 22, "q_value": 0.61},
                                {"move": 2, "visits": 7, "q_value": 0.43},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 2,
                                "visit_top_move": 0,
                            ...
                            "visit_snapshots": [
                                {"simulation": 32, "top_move": 2, "top_visits": 7},
                                {"simulation": 64, "top_move": 0, "top_visits": 22},
                            ],
                        },
                        {
                            "selected_move": 2,
                            "value": 0.54,
                            "policy": [0.1, 0.1, 0.55, 0.15, 0.1, 0.0],
                            "visits": [3, 3, 18, 5, 3, 0],
                            "child_stats": [{"move": 2, "visits": 18, "q_value": 0.49}],
                            "selection_breakdown": {
                                "policy_top_move": 2,
                                "visit_top_move": 2,
                                "q_top_move": 2,
                            ...
                            "visit_snapshots": [
                                {"simulation": 64, "top_move": 2, "top_visits": 18}
                            ],
                        },
                        {
                            "selected_move": 2,
                        ...
                        },
                        {
                            "selected_move": 3,
                            "value": 0.56,
                            "policy": [0.1, 0.1, 0.56, 0.14, 0.1, 0.0],
                            "visits": [2, 2, 6, 19, 3, 0],
                            "child_stats": [
                                {"move": 2, "visits": 6, "q_value": 0.44},
                                {"move": 3, "visits": 19, "q_value": 0.6},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 2,
                                "visit_top_move": 3,
                            ...
                            "visit_snapshots": [
                                {"simulation": 32, "top_move": 2, "top_visits": 6},
                                {"simulation": 64, "top_move": 3, "top_visits": 19},
                            ],
                        },
                        {
                            "selected_move": 4,
                            "value": 0.63,
                            "policy": [0.1, 0.0, 0.2, 0.0, 0.7, 0.0],
                            "visits": [1, 0, 2, 0, 21, 0],
                            "child_stats": [{"move": 4, "visits": 21, "q_value": 0.62}],
                            "selection_breakdown": {
                                "policy_top_move": 4,
                                "visit_top_move": 4,
                                "q_top_move": 4,
                        ...
                        },
                        {
                            ...
                            "visits": [0, 0, 18, 0, 6, 0],
                            "child_stats": [
                                {"move": 2, "visits": 18, "q_value": 0.71},
                                {"move": 4, "visits": 6, "q_value": 0.24},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 4,
                                "visit_top_move": 2,
                        ...
                        },
                        {
                            "selected_move": 4,
                            "value": 0.58,
                            "policy": [0.1, 0.0, 0.18, 0.0, 0.72, 0.0],
                            "visits": [0, 0, 3, 0, 21, 0],
                            "child_stats": [{"move": 4, "visits": 21, "q_value": 0.59}],
                            "selection_breakdown": {
                                "policy_top_move": 4,
                                "visit_top_move": 4,
                                "q_top_move": 4,
                        ...
                        },
                        {
                            ...
                            "visits": [0, 0, 6, 0, 18, 0],
                            "child_stats": [
                                {"move": 4, "visits": 18, "q_value": 0.58},
                                {"move": 2, "visits": 6, "q_value": 0.31},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 4,
                                "visit_top_move": 4,
                        ...
                        },
                        {
                            ...
                            "visits": [4, 18, 10],
                            "child_stats": [
                                {"move": 1, "visits": 18, "q_value": 0.13},
                                {"move": 2, "visits": 10, "q_value": 0.11},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 1,
                                "visit_top_move": 1,
                        ...
                        },
                        {
                            "selected_move": 2,
                            "value": 0.09,
                            "policy": [0.24, 0.46, 0.3],
                            "visits": [5, 11, 16],
                            "child_stats": [
                                {"move": 1, "visits": 11, "q_value": 0.1},
                                {"move": 2, "visits": 16, "q_value": 0.14},
                            ],
                            "selection_breakdown": {
                                "policy_top_move": 1,
                                "visit_top_move": 2,
                            ...
                            "visit_snapshots": [
                                {"simulation": 64, "top_move": 2, "top_visits": 16}
                            ],
                        },
                    ],
                ),
        ...
        self.assertEqual(
            "search_value_interaction_investigation", payload["summary"]["next_branch"]
        )
        ...
        self.assertEqual(
            ...
            payload["rows"]["capture_available-002"]["decision"],
        )
        self.assertEqual(
            "search_overrides_prior",
            payload["rows"]["capture_available-003"]["decision"],
        )
        self.assertEqual(
            "q_value_backup_issue",
            payload["rows"]["incumbent_proxy_disagreement-031"]["decision"],
        )
        self.assertEqual(
            "mixed", payload["rows"]["incumbent_proxy_disagreement-033"]["decision"]
        )
        ...
        self.assertEqual(
            ...
            payload["rows"]["incumbent_proxy_disagreement-031"][
                "row_mechanism_summary"
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            [],
            payload["rows"]["incumbent_proxy_disagreement-033"][
                "rebalanced_challenger"
            ]["visit_snapshots"],
        )
        self.assertEqual(
    ...
    def test_build_search_value_interaction_payload_reuses_one_evaluator_per_artifact(
        self,
    ):
        with tempfile.TemporaryDirectory() as tmp:
            original_run = Path(tmp) / "original"
            ...
            fake_arena = type(
                ...
                (),
                {
                    "ArtifactEvaluator": staticmethod(
                        lambda path: (
                            evaluator_creations.append(str(path)) or f"evaluator:{path}"
                        )
                    ),
                    "build_eval_search_options": staticmethod(
                        lambda: {"root_policy_mode": "deterministic"}
                    ...
                    "evaluate_artifact_position": staticmethod(
                        lambda **kwargs: (
                            evaluate_calls.append(kwargs["evaluator"])
                            or {
                                "selected_move": 2,
                                "value": 0.5,
                                "policy": [0.1, 0.1, 0.6, 0.1, 0.1, 0.0],
    ...
    def test_main_writes_original_and_sibling_search_interaction_artifacts(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            sibling_path = (
                rebalanced_run / "final" / "search_value_interaction_diagnostic.json"
            )
    ...
    def test_build_search_value_interaction_payload_recomputes_summary_from_sibling_rows(
        self,
    ):
        payload = {
            "schema": module.SEARCH_INTERACTION_SCHEMA,
        ...
        sibling_payload = (
            module.build_search_value_interaction_payload_from_source_payload(
                payload=payload,
        ...
        self.assertEqual(
            "broaden_failure_surface_review", sibling_payload["summary"]["next_branch"]
        )
